...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>U</b>NAS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>UNAS</b> Parking</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo site_url()?>input">
            <i class="fa fa-pencil"></i> <span>Input Data Parkir</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url()?>search">
            <i class="fa fa-search"></i> <span>Search Data Parkir</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url()?>data_list">
            <i class="fa fa-table"></i> <span>Data Parkir</span>
          </a>
        </li>
